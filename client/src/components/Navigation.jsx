              ...
              <div className="flex-shrink-0 group block">
                <div className="flex items-center">
                  <div className="hs-dropdown relative">
                    ...
                    >
                      <a
                        className="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-base text-gray-800 hover:bg-gray-200 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                        href="#"
                      >
                        My Bookings
                      </a>
                      <a
                        className="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-base text-gray-800 hover:bg-gray-200 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 cursor-pointer"
                      ...
                      <a
                        className="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-base text-gray-800 hover:bg-gray-200 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 cursor-pointer"
                        onClick={() => dispatch(handleLogOut()) && router.push('/')}
                      >
                        Sign Out
                      </a>
                    </div>
